...
function fnPropertyChanged() {
    if (window.event.propertyName == "src") {
        ...
        if (!el.src.match(/x\.gif$/i)) {
            ...
            el.src = "x.gif"/*tpa=http://livedemo00.template-help.com/virtuemart_37317/components/com_virtuemart/x.gif*/;
        }
    }
}
